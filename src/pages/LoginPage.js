...
const LoginPage = () => {
  ...
  const { login, signInWithGoogle, isNewUser } = useAuth();
      ...
      <div className="relative z-20 max-w-md w-full space-y-8 bg-gray-800/50 backdrop-blur-xl p-8 rounded-xl border border-gray-700/50">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-gray-800/50 backdrop-blur-sm text-gray-400">Or continue with email</span>
          </div>
        </div>

        {error && (
          <div className="bg-red-500/10 backdrop-blur-sm border border-red-500 text-red-500 p-3 rounded-lg text-center">
            {error}
          </div>
        )}
